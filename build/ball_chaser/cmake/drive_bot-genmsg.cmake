...
get_filename_component(_filename "/home/ahmed/catkin_ws/src/ball_chaser/srv/DriveToTarget.srv" NAME_WE)
add_custom_target(_drive_bot_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "drive_bot" "/home/ahmed/catkin_ws/src/ball_chaser/srv/DriveToTarget.srv" ""
)
...
_generate_srv_cpp(drive_bot
  "/home/ahmed/catkin_ws/src/ball_chaser/srv/DriveToTarget.srv"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/drive_bot)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/drive_bot\")")
  # install generated code
  install(
